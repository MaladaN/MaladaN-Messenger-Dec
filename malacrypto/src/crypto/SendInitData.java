...
public class SendInitData implements java.io.Serializable {
    ...
    public ResponsePreKeyBundle getServerResponsePreKeyBundle() {
        int randomPreKeyIdPuller = ThreadLocalRandom.current().nextInt(0, preKeys.size());
        return new ResponsePreKeyBundle(registrationId, preKeys.get(randomPreKeyIdPuller), signedPreKeyId, signedPreKeyPublic, signedPreKeySignature, identityKey);
