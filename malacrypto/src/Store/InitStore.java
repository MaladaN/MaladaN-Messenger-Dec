...
public class InitStore {
    public static void storeIdentityKeyPairAndRegistrationId(IdentityKeyPair identityKeyPair, int localRegistrationId) {
    ...
    public static void setInstalledFlagTrue() {
        Connection conn = GetSQLConnection.getConn();
        if (conn != null) {
